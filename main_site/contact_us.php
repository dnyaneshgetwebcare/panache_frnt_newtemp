...
<div class="site-main main-container no-sidebar">
    <div class="section-041">
        <div class="container">
             <div class="row">
                 <div class="col-md-6">
                 <div class="gmap_canvas"><iframe width="600" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=Panache%20The%20Rental%20Boutique&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><br><style>.mapouter{position:relative;text-align:right;height:500px;width:600px;}</style><style>.gmap_canvas {overflow:hidden;background:none!important;height:500px;width:600px;}</style></div></div>

                        <div class="col-md-6">
                            <div class="container">
                            <h4 class="az_custom_heading">Panache Rental Boutique Store</h4>
                            <p> C-52 Navshantiniketan society, Akurdi,  <br>
                                DY Patil College Rd, Pune, Maharashtra 411035</p>
                            <h4 class="az_custom_heading">Store Hours</h4>
                            <p>Monday-Sunday 11am-7.30 pm
                                </p>
                            <h4 class="az_custom_heading">Contact on</h4>
                            <p>+91 8446287792</p>
                        </div>
                        </div>
